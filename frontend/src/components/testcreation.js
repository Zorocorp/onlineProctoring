...
/>
  ...
  return (
    <>
     <AdminNavbar/>
      <Box sx={{ position: "fixed", top: "64px", bottom: 0, left: 0, right: 0, display: "flex", flexDirection: "column", padding: "16px", overflowY: "auto", width: "100vw", maxWidth: "100%", margin: 0 }}>
