...
import { Container, Card, CardContent, Typography, Switch, FormControl, Select, MenuItem, Button, FormControlLabel, Box, Snackbar} from "@mui/material";
import {  Brightness4, Brightness7, AdminPanelSettings, Save, Undo, Notifications as NotificationsIcon, People, Security, Settings, AssignmentInd as AssignmentIndIcon, Lock as LockIcon } from "@mui/icons-material";
import Navigation from './AdminNavbar.js';
const AdminSettingsPage = () => {
  ...
  const handleSave = async () => {
    ...
    console.log("Stored userId:", localStorage.getItem('userId'));// Log the user ID for debugging
