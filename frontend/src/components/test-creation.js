    ...
    Logout
      ...
      <AppBar position="fixed" sx={{ backgroundColor: "#003366" }}>
        <Toolbar>
          ...
          <Button color="inherit" onClick={() => navigate('/user-dashboard')}>Home</Button>
      ...
      <Box sx={{ position: "fixed", top: "64px", bottom: 0, left: 0, right: 0, display: "flex", flexDirection: "column", padding: "16px", overflowY: "auto", height: "calc(100vh - 144px)", width: "100vw", maxWidth: "100%", margin: 0 }}>
