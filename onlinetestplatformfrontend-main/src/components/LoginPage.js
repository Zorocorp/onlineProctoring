...
const LoginPage = () => {
    ...
    if (response.data.user_token) {
        ...
        // Clear all role-based tokens to avoid leakage
        localStorage.removeItem("admin_token");
        localStorage.removeItem("test_token");

        // Save token with role-based key and set Axios Authorization header
        if (userRole === "admin") {
            localStorage.setItem("admin_token", userToken);
        } else {
            localStorage.setItem("users_token", userToken);
        }
